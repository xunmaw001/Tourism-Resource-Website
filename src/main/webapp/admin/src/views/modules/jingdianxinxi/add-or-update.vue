          ...
          <el-form-item class="input" label="开放时间" prop="kaifangshijian">
              <el-input v-model="ruleForm.kaifangshijian" 
                placeholder="开放时间" readonly></el-input>
                                                                                                                          ...
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="购票须知" prop="goupiaoxuzhi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.goupiaoxuzhi" label="购票须知" prop="goupiaoxuzhi">
                    <span>{{ruleForm.goupiaoxuzhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
